...
/**
 * Cadastra os 10 artigos de SEO (intenção prática / operacional / comercial).
 * Uso: php scripts/seed-blog-articles-11-20.php
 */
...
function seed_post(PDO $pdo, array $post): void
{
    ...
    echo "Criado: {$post['slug']} (~{$chars} caracteres, {$reading} min)\n";
}
...
echo "\nSeed dos artigos 11–20 concluído.\n";
